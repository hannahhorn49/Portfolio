...
# Description: This assignment involves implementing common table algorithms
# using classes and basic object oriented programming (OOP).
# The class we will be writing is called MyPyTable (in mypytable.py)
# and it represents a 2D table of data.
##############################################

"""These modules help us load the data and print the tables"""
